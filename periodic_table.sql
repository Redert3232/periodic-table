...
--
-- Name: elements unique_n; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: elements unique_s; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_s UNIQUE (symbol);
